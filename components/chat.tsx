    ...
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View className="flex-1 bg-background">
          ...
          {isLoading && (
            <View className="absolute bottom-20 left-4 flex-row gap-2 items-center rounded-full bg-gray-100 px-3 py-2">
          ...
          >
            <View className="flex-row items-center gap-3">
              <TextInput
                ref={inputRef}
                className="flex-1 py-4 px-6 bg-gray-100 rounded-3xl"
